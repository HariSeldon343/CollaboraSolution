<?php
/**
 * One-click migration: Tenant logo reference (Migration 49).
 *
...
try {
    ...
    $sqlFile = __DIR__ . '/../database/migrations/49_tenant_logo_file.sql';
    if (!is_file($sqlFile)) {
    ...
    echo "OK: migration 49 applied (tenants.logo_file_id)\n";
} catch (Throwable $e) {
    http_response_code(500);
