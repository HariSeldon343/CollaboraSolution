<?php
/**
 * One-click migration: Users - home_city (Migration 54).
 *
 * Adds optional column to users:
 * - home_city (VARCHAR): user “città di residenza” used as default for Planning travel optimization.
 *
...
try {
    ...
    $sqlFile = __DIR__ . '/../database/migrations/54_users_home_city.sql';
    if (!is_file($sqlFile)) {
    ...
    echo "OK: migration 54 applied (users home_city)\n";
    exit(0);
} catch (Throwable $e) {
    http_response_code(500);
    echo "ERROR applying migration 54: " . $e->getMessage() . "\n";
    exit(1);
}
