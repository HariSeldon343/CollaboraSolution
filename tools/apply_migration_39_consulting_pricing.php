<?php
/**
 * One-click migration: consulting pricing (Migration 39).
 *
 * Adds:
...
try {
    ...
    $sqlFile = __DIR__ . '/../database/migrations/39_consulting_pricing.sql';
    if (!is_file($sqlFile)) {
    ...
    echo "OK: migration 39 applied (pricing defaults + fixed amount)\n";
} catch (Throwable $e) {
    http_response_code(500);
    echo "ERROR applying migration 39: " . $e->getMessage() . "\n";
    exit(1);
}
