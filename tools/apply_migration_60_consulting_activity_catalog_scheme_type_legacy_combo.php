<?php
/**
 * One-click migration: Consulting Activity Catalog (Migration 60).
 *
...
try {
    ...
    $sqlFile = __DIR__ . '/../database/migrations/60_consulting_activity_catalog_scheme_type_legacy_combo.sql';
    if (!is_file($sqlFile)) {
    ...
    echo "OK: migration 60 applied (consulting_activity_types scheme_type, legacy_combo)\n";
    exit(0);
} catch (Throwable $e) {
    http_response_code(500);
    echo "ERROR applying migration 60: " . $e->getMessage() . "\n";
    exit(1);
}
