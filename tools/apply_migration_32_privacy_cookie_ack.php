<?php
// One-click migration tool for Migration 32 (privacy_acknowledgements)
...
$sqlFile = __DIR__ . '/../database/migrations/32_privacy_cookie_ack.sql';
...
if ($isCli) {
    ...
    echo "OK: Migration 32 executed statements: {$executed}\n";
    exit(0);
}
...
<head>
  ...
  <title>Apply Migration 32 - Nexio</title>
  <style>
...
<body>
  <div class="card">
    <div class="h"><strong>Apply Migration 32</strong> — Privacy/Cookie acknowledgements</div>
    <div class="b">
      ...
      <?php else: ?>
        <h3 class="ok">OK</h3>
        <div>Ora <code>privacy_acknowledgements</code> deve risultare OK in <code>tools/db_integrity_audit.php</code>.</div>
      <?php endif; ?>
    </div>
  </div>
</body>
