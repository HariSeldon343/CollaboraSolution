<?php
/**
 * One-click migration: Tenant AI Onboarding (Migration 67).
 *
 * Adds (if missing):
...
try {
    ...
    $sqlFile = __DIR__ . '/../database/migrations/67_tenant_ai_onboarding.sql';
    if (!is_file($sqlFile)) {
    ...
    echo "OK: migration 67 applied (tenant AI onboarding)\n";
    exit(0);
} catch (Throwable $e) {
    http_response_code(500);
    echo "ERROR applying migration 67: " . $e->getMessage() . "\n";
    exit(1);
}
