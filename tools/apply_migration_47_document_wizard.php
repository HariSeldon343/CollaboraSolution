<?php
/**
 * One-click migration: Document Wizard (Migration 47).
 *
...
try {
    ...
    $sqlFile = __DIR__ . '/../database/migrations/47_document_wizard.sql';
    if (!is_file($sqlFile)) {
    ...
    echo "OK: migration 47 applied (document wizard)\n";
} catch (Throwable $e) {
    http_response_code(500);
