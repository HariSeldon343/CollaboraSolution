<?php
/**
 * One-click migration: Consulting plans - consultants home city (Migration 52).
 *
...
try {
    ...
    $sqlFile = __DIR__ . '/../database/migrations/52_consulting_plan_consultants_home_city.sql';
    if (!is_file($sqlFile)) {
    ...
    echo "OK: migration 52 applied (consulting plan consultants home city)\n";
    exit(0);
} catch (Throwable $e) {
    http_response_code(500);
    echo "ERROR applying migration 52: " . $e->getMessage() . "\n";
    exit(1);
}
