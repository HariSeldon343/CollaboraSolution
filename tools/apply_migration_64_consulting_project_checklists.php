<?php
/**
 * One-click migration: Consulting Project Checklists (Migration 64).
 *
 * Creates (if missing):
 * - consulting_project_checklists
 * - consulting_project_checklist_items
 *
...
try {
    ...
    $sqlFile = __DIR__ . '/../database/migrations/64_consulting_project_checklists.sql';
    if (!is_file($sqlFile)) {
    ...
    echo "OK: migration 64 applied (consulting project checklists)\n";
    exit(0);
} catch (Throwable $e) {
    http_response_code(500);
    echo "ERROR applying migration 64: " . $e->getMessage() . "\n";
    exit(1);
}
