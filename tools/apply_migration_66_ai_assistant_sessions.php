<?php
/**
 * One-click migration: AI Assistant sessions (Migration 66).
 *
 * Adds (if missing):
...
try {
    ...
    $sqlFile = __DIR__ . '/../database/migrations/66_ai_assistant_sessions.sql';
    if (!is_file($sqlFile)) {
    ...
    echo "OK: migration 66 applied (ai assistant sessions/messages)\n";
    exit(0);
} catch (Throwable $e) {
    http_response_code(500);
    echo "ERROR applying migration 66: " . $e->getMessage() . "\n";
    exit(1);
}
