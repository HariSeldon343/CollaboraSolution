...
function listFiles() {
    ...
    try {
        // Verifica quale colonna size esiste nella tabella files (size vs size_bytes)
        $check_columns = $pdo->query("SHOW COLUMNS FROM files LIKE 'size%'")->fetchAll(PDO::FETCH_ASSOC);
